...
// Reference: C:\aplikacije\Kadrovska_2_0\dist\KadrovskaRhetosServer\bin\Generated\ServerDom.Model.dll, 2020-05-05T20:02:05.2596634+02:00
// Reference: C:\aplikacije\Kadrovska_2_0\dist\KadrovskaRhetosServer\bin\Generated\ServerDom.Orm.dll, 2020-05-05T20:02:05.4616600+02:00
...
namespace Common
{
    ...
    public class AutofacModuleConfiguration : Autofac.Module
    {
        protected override void Load(Autofac.ContainerBuilder builder)
        {
            ...
            builder.RegisterType<Kadrovska._Helper.Tim_Repository>().Keyed<IRepository>("Kadrovska.Tim").InstancePerLifetimeScope();
...
namespace Kadrovska._Helper
{
    ...
    public class _ModuleRepository
    {
        ...
        private Tim_Repository _Tim_Repository;
        public Tim_Repository Tim { get { return _Tim_Repository ?? (_Tim_Repository = (Tim_Repository)Rhetos.Extensibility.NamedPluginsExtensions.GetPlugin(_repositories, @"Kadrovska.Tim")); } }
        ...
        , IWritableRepository<Kadrovska.Djelatnik>, IValidateRepository/*DataStructureInfo RepositoryInterface Kadrovska.Djelatnik*/
    {
        ...
        public void Save(IEnumerable<Kadrovska.Djelatnik> insertedNew, IEnumerable<Kadrovska.Djelatnik> updatedNew, IEnumerable<Kadrovska.Djelatnik> deletedIds, bool checkUserPermissions = false)
        {
            ...
            catch (System.Data.Entity.Infrastructure.DbUpdateException saveException)
            {
        		...
        		if (interpretedException is Rhetos.UserException && Rhetos.Utilities.MsSqlUtility.IsReferenceErrorOnInsertUpdate(interpretedException, @"Kadrovska.Odjel", @"ID", @"FK_Djelatnik_Odjel_OdjelID"))
                    ((Rhetos.UserException)interpretedException).SystemMessage = @"DataStructure:Kadrovska.Djelatnik,Property:OdjelID,Referenced:Kadrovska.Odjel";
                if (interpretedException is Rhetos.UserException && Rhetos.Utilities.MsSqlUtility.IsReferenceErrorOnInsertUpdate(interpretedException, @"Kadrovska.Sektor", @"ID", @"FK_Djelatnik_Sektor_SektorID"))
                    ((Rhetos.UserException)interpretedException).SystemMessage = @"DataStructure:Kadrovska.Djelatnik,Property:SektorID,Referenced:Kadrovska.Sektor";
                if (interpretedException is Rhetos.UserException && Rhetos.Utilities.MsSqlUtility.IsReferenceErrorOnInsertUpdate(interpretedException, @"Kadrovska.Tim", @"ID", @"FK_Djelatnik_Tim_TimID"))
                    ((Rhetos.UserException)interpretedException).SystemMessage = @"DataStructure:Kadrovska.Djelatnik,Property:TimID,Referenced:Kadrovska.Tim";
                if (interpretedException is Rhetos.UserException && Rhetos.Utilities.MsSqlUtility.IsReferenceErrorOnDelete(interpretedException, @"Kadrovska.Tim", @"VoditeljID", @"FK_Tim_Djelatnik_VoditeljID"))
                    ((Rhetos.UserException)interpretedException).SystemMessage = @"DataStructure:Kadrovska.Tim,Property:VoditeljID,Referenced:Kadrovska.Djelatnik";
        ...
        , IWritableRepository<Kadrovska.Odjel>, IValidateRepository/*DataStructureInfo RepositoryInterface Kadrovska.Odjel*/
    {
        ...
        public void Save(IEnumerable<Kadrovska.Odjel> insertedNew, IEnumerable<Kadrovska.Odjel> updatedNew, IEnumerable<Kadrovska.Odjel> deletedIds, bool checkUserPermissions = false)
        {
            ...
            catch (System.Data.Entity.Infrastructure.DbUpdateException saveException)
            {
                DomHelper.ThrowIfSavingNonexistentId(saveException, checkUserPermissions, saveOperation);
        		Rhetos.RhetosException interpretedException = _sqlUtility.InterpretSqlException(saveException);
        		if (interpretedException is Rhetos.UserException && Rhetos.Utilities.MsSqlUtility.IsReferenceErrorOnDelete(interpretedException, @"Kadrovska.Djelatnik", @"OdjelID", @"FK_Djelatnik_Odjel_OdjelID"))
                    ((Rhetos.UserException)interpretedException).SystemMessage = @"DataStructure:Kadrovska.Djelatnik,Property:OdjelID,Referenced:Kadrovska.Odjel";
        ...
        , IWritableRepository<Kadrovska.Sektor>, IValidateRepository/*DataStructureInfo RepositoryInterface Kadrovska.Sektor*/
    {
        ...
        public void Save(IEnumerable<Kadrovska.Sektor> insertedNew, IEnumerable<Kadrovska.Sektor> updatedNew, IEnumerable<Kadrovska.Sektor> deletedIds, bool checkUserPermissions = false)
        {
            ...
            catch (System.Data.Entity.Infrastructure.DbUpdateException saveException)
            {
                DomHelper.ThrowIfSavingNonexistentId(saveException, checkUserPermissions, saveOperation);
        		Rhetos.RhetosException interpretedException = _sqlUtility.InterpretSqlException(saveException);
        		if (interpretedException is Rhetos.UserException && Rhetos.Utilities.MsSqlUtility.IsReferenceErrorOnDelete(interpretedException, @"Kadrovska.Djelatnik", @"SektorID", @"FK_Djelatnik_Sektor_SektorID"))
                    ((Rhetos.UserException)interpretedException).SystemMessage = @"DataStructure:Kadrovska.Djelatnik,Property:SektorID,Referenced:Kadrovska.Sektor";
    ...
    /*DataStructureInfo RepositoryAttributes Kadrovska.Tim*/
    public class Tim_Repository : /*DataStructureInfo OverrideBaseType Kadrovska.Tim*/ Common.OrmRepositoryBase<Common.Queryable.Kadrovska_Tim, Kadrovska.Tim> // Common.QueryableRepositoryBase<Common.Queryable.Kadrovska_Tim, Kadrovska.Tim> // Common.ReadableRepositoryBase<Kadrovska.Tim> // global::Common.RepositoryBase
        , IWritableRepository<Kadrovska.Tim>, IValidateRepository/*DataStructureInfo RepositoryInterface Kadrovska.Tim*/
    {
        private readonly Rhetos.Utilities.ISqlUtility _sqlUtility;
        /*DataStructureInfo RepositoryPrivateMembers Kadrovska.Tim*/

        public Tim_Repository(Common.DomRepository domRepository, Common.ExecutionContext executionContext, Rhetos.Utilities.ISqlUtility _sqlUtility/*DataStructureInfo RepositoryConstructorArguments Kadrovska.Tim*/)
        {
            _domRepository = domRepository;
            _executionContext = executionContext;
            this._sqlUtility = _sqlUtility;
            /*DataStructureInfo RepositoryConstructorCode Kadrovska.Tim*/
        }

        [Obsolete("Use Load() or Query() method.")]
        public override global::Kadrovska.Tim[] All()
        {
            return Query().ToSimple().ToArray();
        }

        public override IQueryable<Common.Queryable.Kadrovska_Tim> Query()
        {
            /*DataStructureInfo RepositoryBeforeQuery Kadrovska.Tim*/
            return _executionContext.EntityFrameworkContext.Kadrovska_Tim.AsNoTracking();
        }

        public void Save(IEnumerable<Kadrovska.Tim> insertedNew, IEnumerable<Kadrovska.Tim> updatedNew, IEnumerable<Kadrovska.Tim> deletedIds, bool checkUserPermissions = false)
        {
            if (!DomHelper.CleanUpSaveMethodArguments(ref insertedNew, ref updatedNew, ref deletedIds))
                return;

            /*DataStructureInfo WritableOrm ClearContext Kadrovska.Tim*/

            {
                ...
                if (invalidItem != null)
                    throw new Rhetos.UserException(
                        "Maximum length of property {0} is {1}.",
                        new[] { "Tim.Naziv", "256" },
                        "DataStructure:Kadrovska.Tim,ID:" + invalidItem.ID.ToString() + ",Property:Naziv",
                        null);
            }
            /*DataStructureInfo WritableOrm ArgumentValidation Kadrovska.Tim*/

            /*DataStructureInfo WritableOrm Initialization Kadrovska.Tim*/

            // Using old data, including lazy loading of navigation properties:
		    IEnumerable<Common.Queryable.Kadrovska_Tim> deleted;
		    if(deletedIds.Any())
                deleted = this.Query(deletedIds.Select(item => item.ID)).ToList();
            else
                deleted = new List<Common.Queryable.Kadrovska_Tim>();
            Rhetos.Utilities.Graph.SortByGivenOrder((List<Common.Queryable.Kadrovska_Tim>)deleted, deletedIds.Select(item => item.ID), item => item.ID);
		    IEnumerable<Common.Queryable.Kadrovska_Tim> updated;
		    if(updatedNew.Any())
                updated = this.Query(updatedNew.Select(item => item.ID)).ToList();
            else
                updated = new List<Common.Queryable.Kadrovska_Tim>();
            Rhetos.Utilities.Graph.SortByGivenOrder((List<Common.Queryable.Kadrovska_Tim>)updated, updatedNew.Select(item => item.ID), item => item.ID);

            /*DataStructureInfo WritableOrm OldDataLoaded Kadrovska.Tim*/

            {
                var invalid = insertedNew.Concat(updatedNew).FirstOrDefault(item => item.Naziv == null || string.IsNullOrWhiteSpace(item.Naziv) /*RequiredPropertyInfo OrCondition Kadrovska.Tim.Naziv*/);
                if (invalid != null)
                    throw new Rhetos.UserException("It is not allowed to enter {0} because the required property {1} is not set.",
                        new[] { "Kadrovska.Tim", "Naziv" },
                        "DataStructure:Kadrovska.Tim,ID:" + invalid.ID.ToString() + ",Property:Naziv", null);
            }
            {
                var invalid = insertedNew.Concat(updatedNew).FirstOrDefault(item => item.VoditeljID == null /*RequiredPropertyInfo OrCondition Kadrovska.Tim.Voditelj*/);
                if (invalid != null)
                    throw new Rhetos.UserException("It is not allowed to enter {0} because the required property {1} is not set.",
                        new[] { "Kadrovska.Tim", "Voditelj" },
                        "DataStructure:Kadrovska.Tim,ID:" + invalid.ID.ToString() + ",Property:VoditeljID", null);
            }
            /*DataStructureInfo WritableOrm ProcessedOldData Kadrovska.Tim*/
            ...
            try
            {
                ...
                {
                    saveOperation = DomHelper.SaveOperation.Insert;
                    _executionContext.EntityFrameworkContext.Kadrovska_Tim.AddRange(insertedNew.Select(item => item.ToNavigation()));
                    _executionContext.EntityFrameworkContext.SaveChanges();
                }
            ...
            catch (System.Data.Entity.Infrastructure.DbUpdateException saveException)
            {
                DomHelper.ThrowIfSavingNonexistentId(saveException, checkUserPermissions, saveOperation);
        		Rhetos.RhetosException interpretedException = _sqlUtility.InterpretSqlException(saveException);
        		if (interpretedException is Rhetos.UserException && Rhetos.Utilities.MsSqlUtility.IsReferenceErrorOnDelete(interpretedException, @"Kadrovska.Djelatnik", @"TimID", @"FK_Djelatnik_Tim_TimID"))
                    ((Rhetos.UserException)interpretedException).SystemMessage = @"DataStructure:Kadrovska.Djelatnik,Property:TimID,Referenced:Kadrovska.Tim";
                if (interpretedException is Rhetos.UserException && Rhetos.Utilities.MsSqlUtility.IsReferenceErrorOnInsertUpdate(interpretedException, @"Kadrovska.Djelatnik", @"ID", @"FK_Tim_Djelatnik_VoditeljID"))
                    ((Rhetos.UserException)interpretedException).SystemMessage = @"DataStructure:Kadrovska.Tim,Property:VoditeljID,Referenced:Kadrovska.Djelatnik";
                if (interpretedException is Rhetos.UserException && Rhetos.Utilities.MsSqlUtility.IsUniqueError(interpretedException, @"Kadrovska.Tim", @"IX_Tim_Naziv"))
                    ((Rhetos.UserException)interpretedException).SystemMessage = @"DataStructure:Kadrovska.Tim,Property:Naziv";
                if (interpretedException is Rhetos.UserException && Rhetos.Utilities.MsSqlUtility.IsUniqueError(interpretedException, @"Kadrovska.Tim", @"IX_Tim_Voditelj"))
                    ((Rhetos.UserException)interpretedException).SystemMessage = @"DataStructure:Kadrovska.Tim,Property:Voditelj";
                /*DataStructureInfo WritableOrm OnDatabaseError Kadrovska.Tim*/
                if (checkUserPermissions)
                    Rhetos.Utilities.MsSqlUtility.ThrowIfPrimaryKeyErrorOnInsert(interpretedException, "Kadrovska.Tim");
            ...
            deleted = null;
            updated = this.Query(updatedNew.Select(item => item.ID));
            IEnumerable<Common.Queryable.Kadrovska_Tim> inserted = this.Query(insertedNew.Select(item => item.ID));

            bool allEffectsCompleted = false;
            try
            {
                /*DataStructureInfo WritableOrm OnSaveTag1 Kadrovska.Tim*/

                /*DataStructureInfo WritableOrm OnSaveTag2 Kadrovska.Tim*/

                Rhetos.Dom.DefaultConcepts.InvalidDataMessage.ValidateOnSave(insertedNew, updatedNew, this, "Kadrovska.Tim");

                /*DataStructureInfo WritableOrm AfterSave Kadrovska.Tim*/
        ...
        public IEnumerable<Rhetos.Dom.DefaultConcepts.InvalidDataMessage> Validate(IList<Guid> ids, bool onSave)
        {
            /*DataStructureInfo WritableOrm OnSaveValidate Kadrovska.Tim*/
            yield break;
        }

        /*DataStructureInfo RepositoryMembers Kadrovska.Tim*/
    }
