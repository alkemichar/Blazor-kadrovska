...
namespace Common
{
    ...
    public class EntityFrameworkContext : System.Data.Entity.DbContext, Rhetos.Persistence.IPersistenceCache
    {
        ...
        protected override void OnModelCreating(System.Data.Entity.DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Common.Queryable.Kadrovska_Djelatnik>()
                .HasOptional(t => t.Odjel).WithMany()
                .HasForeignKey(t => t.OdjelID);
            ...
            modelBuilder.Entity<Common.Queryable.Kadrovska_Djelatnik>()
                .HasOptional(t => t.Sektor).WithMany()
                .HasForeignKey(t => t.SektorID);
            modelBuilder.Ignore<global::Kadrovska.Tim>();
            modelBuilder.Entity<Common.Queryable.Kadrovska_Tim>().Map(m => { m.MapInheritedProperties(); m.ToTable("Tim", "Kadrovska"); });
            modelBuilder.Entity<Common.Queryable.Kadrovska_Djelatnik>()
                .HasOptional(t => t.Tim).WithMany()
                .HasForeignKey(t => t.TimID);
            modelBuilder.Entity<Common.Queryable.Kadrovska_Tim>()
        ...
        public System.Data.Entity.DbSet<Common.Queryable.Kadrovska_Tim> Kadrovska_Tim { get; set; }
